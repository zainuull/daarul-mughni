...
import { BsCalendarCheck, BsQuestionCircle } from 'react-icons/bs';
...
const Menu = (props) => {
  ...
  return (
    <div
      className={`${
        menu ? 'w-1/4 transition-all duration-700' : 'w-[150px] transition-all duration-700'
      } h-full p-4 shadow-2xl shadow-gray-300`}>
      <div className="w-full h-full flex flex-col gap-y-2 mt-4">
        <div className="w-full flex items-center justify-center gap-x-4">
          <RxDashboard size={30} />
          {menu && <h1 className="text-2xl font-medium">Dashboard</h1>}
        </div>
        <div className="flex flex-col gap-y-10 mt-20 w-full px-6">
          <Link
            ...
            <div className="flex items-center gap-x-6">
              ...
              {menu && <h1 className="">Dashboard</h1>}
            </div>
          ...
          <Link
            ...
            <div className="flex items-center gap-x-6">
              <BiCubeAlt size={30} />
              {menu && <h1 className="">Data Guru</h1>}
            </div>
            <BiChevronRight size={20} />
          </Link>
          <Link
            ...
            <div className="flex items-center gap-x-6">
              ...
              {menu && <h1 className="">Data Siswa</h1>}
            </div>
            <BiChevronRight size={20} />
          </Link>
          <Link
            ...
            <div className="flex items-center gap-x-6">
              ...
              {menu && <h1 className="">Laporan Kegiatan</h1>}
            </div>
            <BiChevronRight size={20} />
          </Link>
          <Link
