...
const Pagination = () => {
  ...
  return (
    <div className="flex gap-x-2 items-center justify-evenly p-2 rounded-md w-[300px]">
      <div
        className={`shadow-md rounded-lg flex items-center px-6 py-2
      ...
      <div className="bg-white rounded-lg flex items-center gx-2 cursor-pointer">
        {pageNumbers.map((n) => (
          <div
